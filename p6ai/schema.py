...
REQUIRED_TABLES = {
    "PROJECT": [
        "PROJ_ID", "PROJ_SHORT_NAME", "ORIG_PROJ_ID", "CLNDR_ID",
        "PLAN_START_DATE", "PLAN_END_DATE", "ADD_DATE", "LAST_SCHEDULE_DATE",
        "GUID", "PROJECT_FLAG", "CHECKOUT_FLAG", "FINTMPL_ID",
        "DEF_DURATION_TYPE", "DEF_TASK_TYPE", "TASK_CODE_PREFIX",
        "CRITICAL_PATH_TYPE", "SUM_ASSIGN_LEVEL",
